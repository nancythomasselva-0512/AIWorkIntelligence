...
const About = () => {
  return (
    <section className="container about-section" style={{ paddingTop: '2rem', paddingBottom: '3rem' }}>
      <div className="text-center max-w-3xl mx-auto mb-2 about-heading-wrapper">
        <h2 style={{ fontSize: '2.5rem', fontWeight: 'bold', color: '#000000' }}>
          About <span style={{ color: 'var(--accent-lime)' }}>Us</span>
        </h2>
      </div>

      <div className="flex flex-col lg:flex-row about-flex-container" style={{ gap: '5rem', alignItems: 'flex-start', marginBottom: '6rem' }}>

        {/* Left Side: Header & Image */}
        <div style={{ flex: 1 }}>
          <div className="about-logo-wrapper" style={{ display: 'flex', alignItems: 'center', marginBottom: '1.5rem' }}>
            <img
        ...
        {/* Right Side: Content */}
        <div className="mt-8 lg:mt-[60px] about-right-content" style={{ flex: 1 }}>
          ...
          <div style={{
            ...
            <a href="https://www.tekquora.com/" target="_blank" rel="noopener noreferrer" className="btn btn-lime" style={{ padding: '0.6rem 1.2rem', fontSize: '0.85rem', textDecoration: 'none', display: 'inline-block', textAlign: 'center', flexShrink: 0 }}>
              Learn More →
            </a>
          </div>
        </div>
