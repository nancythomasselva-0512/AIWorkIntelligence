          ...
          <div className="space-y-8">
            ...
            <div style={{ backgroundColor: '#f8f9fa', padding: '2rem', borderRadius: '1.5rem', display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
              ...
              <div>
                ...
                <p style={{ color: '#666' }}>123 AI Boulevard, Tech District, CA 90210</p>
              </div>
            </div>
          </div>
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" style={{ width: '100%', backgroundColor: '#ffffff', border: '1px solid #ddd', borderRadius: '0.75rem', padding: '0.75rem 1rem', outline: 'none' }} placeholder="John" />
                </div>
                <div>
                  <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 'bold', color: '#666', marginBottom: '0.5rem' }}>Last Name</label>
                  <input type="text" style={{ width: '100%', backgroundColor: '#ffffff', border: '1px solid #ddd', borderRadius: '0.75rem', padding: '0.75rem 1rem', outline: 'none' }} placeholder="Doe" />
                </div>
              </div>
              
              <div>
                <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 'bold', color: '#666', marginBottom: '0.5rem' }}>Email Address</label>
                <input type="email" style={{ width: '100%', backgroundColor: '#ffffff', border: '1px solid #ddd', borderRadius: '0.75rem', padding: '0.75rem 1rem', outline: 'none' }} placeholder="john@company.com" />
              </div>

              <div>
                <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 'bold', color: '#666', marginBottom: '0.5rem' }}>Message</label>
                <textarea rows={5} style={{ width: '100%', backgroundColor: '#ffffff', border: '1px solid #ddd', borderRadius: '0.75rem', padding: '0.75rem 1rem', outline: 'none', resize: 'none' }} placeholder="How can we help you?"></textarea>
              </div>

              <button type="submit" style={{ width: '100%', backgroundColor: 'var(--accent-lime)', color: '#071420', fontWeight: 'bold', padding: '1rem', borderRadius: '0.75rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', border: 'none', cursor: 'pointer' }}>
